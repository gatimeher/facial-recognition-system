...
namespace FRS
{
    public partial class FaceAttendanceReport : System.Web.UI.Page
    {
        ...
        protected void Button1_Click1(object sender, EventArgs e)
        {
            ...
            //string query = "select distinct s.Student_Name,s.Batch_Code,f.Email_ID,f.DateTime,f.Attendance from AddStudentDB as s inner join FaceAttendance as f on s.Email_ID = f.Email_ID where f.Student_Name='" + TextBox1.Text + "'";
            string query = "select distinct s.Student_Name,s.Batch_Code,f.Email_ID,f.DateTime,f.Attendance from AddStudentDB as s inner join FaceAttendance as f on s.Email_ID = f.Email_ID where f.Email_ID='" + TextBox1.Text + "'";
        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            ...
            SqlConnection con = new SqlConnection(maincon);
            //string query = "select distinct s.Student_Name,s.Batch_Code,f.Email_ID,f.DateTime,f.Attendance from AddStudentDB as s inner join FaceAttendance as f on s.Email_ID = f.Email_ID where f.Student_Name='" + TextBox1.Text + "'";
            string query = "select distinct f.Faculty_Name,f.Batch_Code,a.Email_ID,a.DateTime,a.Attendance from AddFacultyDB as f inner join FaceAttendance as a on f.Email_ID = a.Email_ID where a.Email_ID='" + TextBox1.Text + "'";
