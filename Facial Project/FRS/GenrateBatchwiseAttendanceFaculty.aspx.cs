...
namespace FRS
{
    public partial class GenrateBatchwiseAttendanceFaculty : System.Web.UI.Page
    {
        ...
        {
            SqlConnection con = new SqlConnection("data source=DESKTOP-6RGINGV\\SQLEXPRESS;integrated security=true;database=FRSDatabase");
            ...
            string fn = Session["Full_Name"].ToString();
