...
<font color="black">
        ...
        <table align="center" class="auto-style2">
            <tr>
                <td>Select Batch</td>
                <td>
                    <asp:DropDownList ID="DropDownList1" runat="server" AutoPostBack="True" DataSourceID="SqlDataSource1" DataTextField="Batch_Code" DataValueField="Batch_Code" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged">
                    </asp:DropDownList>
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:FRSDatabaseConnectionString70 %>" SelectCommand="SELECT [Batch_Code] FROM [BatchDB]"></asp:SqlDataSource>
                </td>
            </tr>
            <tr>
                <td>&nbsp;</td>
            ...
            <tr>
                <td>&nbsp;</td>
                <td>
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource3" DataKeyNames="Id">
                        <Columns>
                    ...
                    <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:FRSDatabaseConnectionString71 %>" SelectCommand="SELECT [Teacher_Name], [Subject], [Batch_Time], [Batch_Code], [Id] FROM [BatchDB] WHERE ([Batch_Code] = @Batch_Code)" DeleteCommand="DELETE FROM [BatchDB] WHERE [Id] = @Id" InsertCommand="INSERT INTO [BatchDB] ([Teacher_Name], [Subject], [Batch_Time], [Batch_Code]) VALUES (@Teacher_Name, @Subject, @Batch_Time, @Batch_Code)" UpdateCommand="UPDATE [BatchDB] SET [Teacher_Name] = @Teacher_Name, [Subject] = @Subject, [Batch_Time] = @Batch_Time, [Batch_Code] = @Batch_Code WHERE [Id] = @Id">
                        <DeleteParameters>
