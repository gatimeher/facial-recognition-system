    ...
    <form id="form1" runat="server">
        ...
        <table align="center" class="auto-style2">
            <tr>
                ...
                <td><strong>
                    <asp:DropDownList ID="DropDownList1" runat="server" AutoPostBack="True" DataSourceID="SqlDataSource1" DataTextField="Faculty_Name" DataValueField="Faculty_Name" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged">
                    </asp:DropDownList>
                    </strong>
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:FRSDatabaseConnectionString79 %>" SelectCommand="SELECT [Faculty_Name] FROM [AddFacultyDB]"></asp:SqlDataSource>
                </td>
            </tr>
            <tr>
                <td>&nbsp;</td>
            ...
            <tr>
                ...
                <td>
                    ...
                    <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:FRSDatabaseConnectionString81 %>" SelectCommand="SELECT [Faculty_Name], [Address], [Phone_Number], [Gender], [User_ID] FROM [AddFacultyDB] WHERE ([Faculty_Name] = @Faculty_Name)">
                        <SelectParameters>
