        ...
        <table align="center" class="auto-style2">
            ...
            <tr>
                ...
                <td>
                    ...
                    <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:FRSDatabaseConnectionString54 %>" SelectCommand="SELECT [Student_Name] FROM [AddStudentDB]" OnSelecting="SqlDataSource2_Selecting"></asp:SqlDataSource>
                </td>
            </tr>
            <tr>
                <td class="auto-style3">&nbsp;</td>
            ...
            <tr>
                <td class="auto-style3">&nbsp;</td>
                <td>
                    <asp:SqlDataSource ID="SqlDataSource4" runat="server" ConnectionString="<%$ ConnectionStrings:FRSDatabaseConnectionString56 %>" SelectCommand="SELECT [Student_ID], [Student_Name], [Address], [Phone_Number], [Gender], [Batch_Code] FROM [AddStudentDB] WHERE ([Student_Name] = @Student_Name)" DeleteCommand="DELETE FROM [AddStudentDB] WHERE [Student_ID] = @Student_ID" InsertCommand="INSERT INTO [AddStudentDB] ([Student_Name], [Address], [Phone_Number], [Gender], [Batch_Code]) VALUES (@Student_Name, @Address, @Phone_Number, @Gender, @Batch_Code)" UpdateCommand="UPDATE [AddStudentDB] SET [Student_Name] = @Student_Name, [Address] = @Address, [Phone_Number] = @Phone_Number, [Gender] = @Gender, [Batch_Code] = @Batch_Code WHERE [Student_ID] = @Student_ID">
                        <DeleteParameters>
