...
namespace FRS
{
    public partial class ViewDateWiseAttendanceReport : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            string query1 = "select Full_Name from registerDB where email_id= '" + str1 + "'";
            ...
            string rq = "select * from StudentMarkManualAttendanceDB where Student_Name='" + fn + "'and date between'" + TextBox1.Text + "'and'" + TextBox2.Text + "'";
