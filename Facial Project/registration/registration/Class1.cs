...
namespace registration
{
    public class Register
    {
        ...
        public Register()
        {
            cn = "data source=DESKTOP-6RGINGV\\SQLEXPRESS;integrated security=true;database=FRSDatabase";
        ...
        public string Saveregistration(string f, string add, string mob, string e, string gen, string pass, string cpass, string dob, string doj, string id, string idnum,string r)
        {
            ...
            try
            {
                ...
                string qr = "insert into registerDB(Full_Name,Address,Contact_Number,Gender,Email_ID,Password,Conform_Password,Date_Of_Birth,Date_Of_Joining,ID_Proof,ID_Proof_Number,Role) values('" + fullname + "','" + address + "','" + contactnumber + "','" + gender + "','" + emailid + "','" + password + "','" + conformpassword + "','" + dateofbirth + "','" + dateofjoining + "','" + idproof + "','" + idproofnumber + "','" + role + "')";
